...
echo "-Install Vundle with git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim to ensure your vim plugins work. Remembre to run :PluginInstall." >> ~/reprov_todo.txt
