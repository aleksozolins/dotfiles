...
#+RESULTS:
: GNU Emacs 29.4 (build 1, aarch64-apple-darwin23.6.0, NS appkit-2487.70 Version 14.7 (Build 23H124))
:  of 2024-10-02
...
This is needed only on the Mac and makes Emacs can evaluate $PATH correctly.
