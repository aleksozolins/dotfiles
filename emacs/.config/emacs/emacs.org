...
This function, meant to be run on Friday, will look through the last 7 days of org-roam daily org files, take all content from the Zapier top level heading, and create a new org file with everything from this week in =~/Dropbox/docs/zapier/friday_update_gen/=.
