...
I also like to have James Cherti's =tomorrow-night-deepblue-theme= installed for that old-school Norton Commander look. We won't activate this out of the box for now, but we can use =consult-theme= to switch to it.
