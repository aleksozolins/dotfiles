...
*Note:* This is ugly code below as we have had to call a keyboard macro since ~denote-keywords-remove~ does not accept a list of strings like the add function in the function above. Might want to make this more efficient in the future.
